...
if ($choice eq "1") {
				...
				6= OID, Service Ticket, ReleaseType\n";
                ...
                last;
                    ...
                    last;              
							...
							my $fname = "RetrieveValueSet_version.xml";
     						...
     						my $fname = "RetrieveValueSet_draft.xml";
							  ...
							  if (-e $fname) {
								...
								print RVS "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"."\n";		
								 ...
								 #print $oid."\n";
									$servTic = serviceTicket($service, $cas);
												$rclient->GET($RVS . $oid . '&includeDraft=' . $draft. '&ticket=' . $servTic);
												my $get_response = $rclient->responseContent();
												my @arr_get_res = split(/\n/, $get_response);
												foreach my $arr_get_res(@arr_get_res){
												if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){
                                ...
                                last;              
															...
															while (!$relT){
                                                               print "Enter the releaseType:";
                                                                $relType = <>;
                                                                chomp($relType);                                                               
                                                                if (($relType eq "\n") || ($relType eq "")){ #checking for blank inputs.
                                                                print "Invalid input!!"."\n";
     						...
     						my $fname = "RetrieveValueSet_releaseType.xml";
							  ...
							  if (-e $fname) {
								...
								print RVS "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"."\n";		
								 ...
								 #print $oid."\n";
									$servTic = serviceTicket($service, $cas);
												$rclient->GET($RVS . $oid . '&releaseType=' . $relType . '&ticket=' . $servTic);
												my $get_response = $rclient->responseContent();
												my @arr_get_res = split(/\n/, $get_response);
												foreach my $arr_get_res(@arr_get_res){
												if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){
   ...
   #For Retrieving Multiple Value Set
                ...
                9= OID, Service Ticket, ReleaseType \n";
                    ...
                    last;                           
						...
						my $fname = "RetrieveMultipleValueSets_cms.xml";
							  ...
							  if (-e $fname) {
                                ...
                                $rclient->GET($RMVS . $oid . 'cmsemeasureid='. $cms. '&ticket=' . $servTic);
                                my $get_response = $rclient->responseContent();
								my @arr_get_res = split(/\n/, $get_response);
								foreach my $arr_get_res(@arr_get_res){
								if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){
						...
						my $fname = "RetrieveMultipleValueSets_NQF.xml";
							  ...
							  if (-e $fname) {
                                ...
                                $rclient->GET($RMVS . $oid . 'NQFNumber='. $nqfNum. '&ticket=' . $servTic);
                                my $get_response = $rclient->responseContent();
								my @arr_get_res = split(/\n/, $get_response);
								foreach my $arr_get_res(@arr_get_res){
								if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){
						...
						my $fname = "RetrieveMultipleValueSets_MeasureId.xml";
							  ...
							  if (-e $fname) {
                                ...
                                $rclient->GET($RMVS . $oid . '&measureId=' . $measureId . '&ticket=' . $servTic);
                                my $get_response = $rclient->responseContent();
								my @arr_get_res = split(/\n/, $get_response);
								foreach my $arr_get_res(@arr_get_res){
								if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){
						...
						my $fname = "RetrieveMultipleValueSets_draft.xml";
							  ...
							  if (-e $fname) {
                                ...
                                $rclient->GET($RMVS . $oid . '&includeDraft=' . $draft . '&ticket=' . $servTic);
                                my $get_response = $rclient->responseContent();
								my @arr_get_res = split(/\n/, $get_response);
								foreach my $arr_get_res(@arr_get_res){
								if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){
						...
						my $fname = "RetrieveMultipleValueSets_ReleaseType.xml";
							  ...
							  if (-e $fname) {
                                ...
                                $rclient->GET($RMVS . $oid . '&releaseType=' . $MU . '&ticket=' . $servTic);
                                my $get_response = $rclient->responseContent();
								my @arr_get_res = split(/\n/, $get_response);
								foreach my $arr_get_res(@arr_get_res){
								if ($arr_get_res eq "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"){

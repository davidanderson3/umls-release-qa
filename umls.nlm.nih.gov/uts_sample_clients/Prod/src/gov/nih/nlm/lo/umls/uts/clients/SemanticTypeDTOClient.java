...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            switch (method) {
            case "getSemanticTypes": myarrSemTyRelDTO = utsSemanticNetworkService.getSemanticTypes(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "DISO");
            break;

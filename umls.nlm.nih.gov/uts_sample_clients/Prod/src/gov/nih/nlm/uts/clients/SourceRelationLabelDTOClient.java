...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
			...
			SourceRelationLabelDTOClient SrcRelLabelClient = new SourceRelationLabelDTOClient(args[0],args[1]);
            ...
            //String acquisitionContact = mySourceRelationLabel.getRootSource().getAcquisitionContact().getCountry();
            String contentContact = mySourceRelationLabel.getRootSource().getContentContact().getName();
            String licenseContact = mySourceRelationLabel.getRootSource().getLicenseContact().getAddress1();
            String language = mySourceRelationLabel.getRootSource().getLanguage().getExpandedForm();
            ...
            //String acquisitionContact = mySourceRelationLabelDTO.getRootSource().getAcquisitionContact().getName();
            String contentContact = mySourceRelationLabelDTO.getRootSource().getContentContact().getName();
            String licenseContact = mySourceRelationLabelDTO.getRootSource().getLicenseContact().getName();

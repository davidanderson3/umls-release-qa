...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            System.out.println("ExpandedForm:"+expandedForm+"|Abbreviation:"+abbreviation+"|inverseAbbr:"+inverseAbbr+"|inverseExpandedForm:"+inverseExpandedForm);
            break;
            ...
            //RelationLabelDTO inverseAbbr = myRelationLabelDTO.getInverse();
            System.out.println("ExpandedForm:"+expandedForm+"\nAbbreviation:"+abbreviation);

            //if (null != myRelationLabelDTO.getInverse().getAbbreviation()){
            String inverseAbbr = myRelationLabelDTO.getInverse().getAbbreviation();
            System.out.println("inverseAbbr:"+inverseAbbr);
           // }
            
           // if (myRelationLabelDTO.getInverse().getExpandedForm() != null){
            String inverseExpandedForm = myRelationLabelDTO.getInverse().getExpandedForm();
            System.out.println("inverseExpandedForm:"+inverseExpandedForm);
           // }

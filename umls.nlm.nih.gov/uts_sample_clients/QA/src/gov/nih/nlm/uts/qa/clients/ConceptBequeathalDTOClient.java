...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            switch (method) {
            case "getConceptBequeathals": myconceptBeqDTO = utsHistoryService.getConceptBequeathals(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "C0039644", "");
            break;
            ...
            System.out.println("|"+label+"|"+ui+"|"+relConceptUi+"|"+version+"|");
            }

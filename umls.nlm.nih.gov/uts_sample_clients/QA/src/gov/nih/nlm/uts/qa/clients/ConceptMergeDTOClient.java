...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            switch (method) {
            case "getConceptMerges": myConceptMergeDTO = utsHistoryService.getConceptMerges(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "C0000258", "1993AA");
            break;
            ...
            System.out.println("&lt;tr&gt;&lt;td&gt;"+newUi+"&lt;/td&gt;\n&lt;td&gt;"+ui+"&lt;/td&gt;\n&lt;td&gt;"+version+"&lt;/td&gt;\n");
            }

...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            switch (method) {
            case "getAtomMovements": myAtomMovementDTO = utsHistoryService.getAtomMovements(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "A0005183");
            break;

		...
		static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
			...
			public static void main(String[] args) {
				...
				try {
					...
					List<LanguageDTO> myArrLang = new ArrayList<LanguageDTO>();
		            ...
		            switch (method) {
		            case "getAllLanguages": myArrLang = utsMetadataService.getAllLanguages(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease);
		            break;
		            case "getLanguage": languageDTO = utsMetadataService.getLanguage(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "DUT");
		            ...
		            for (int i = 0; i < myArrLang.size(); i++) {

		            LanguageDTO myArrSrcDTO = myArrLang.get(i);

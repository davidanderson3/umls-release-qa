...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            switch (method) {
            case "getBequeathedToConceptCuis": myarrString = utsHistoryService.getBequeathedToConceptCuis(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "C2962996", "2011AA");

...
static UtsWsSecurityController securityService = (new UtsWsSecurityControllerImplService()).getUtsWsSecurityControllerImplPort();
	...
	public static void main(String[] args) {
		...
		try {
            ...
            switch (method) {
            case "getSourceAtomChanges": mySrcAtomChange = utsHistoryService.getSourceAtomChanges(securityService.getProxyTicket(ticketGrantingTicket(), serviceName), umlsRelease, "C1264709", "SNOMEDCT", "");
            break;
            ...
            System.out.println("&lt;tr&gt;&lt;td&gt;"+key+"&lt;/td&gt;\n&lt;td&gt;"+rtSource+"&lt;/td&gt;\n&lt;td&gt;"+ui+"&lt;/td&gt;\n&lt;td&gt;"+srcUi+"&lt;/td&gt;\n&lt;td&gt;"+value+"&lt;/td&gt;\n&lt;td&gt;"+version+"&lt;/td&gt;\n");
            }

...
# if needed replace file path in all scripts with your local file path
# for example replace C:\Users\rewolinskija\Documents\umls-source-release\umls.nlm.nih.gov\releasedocs\2024AA\License scripts\
...
# ---------------------------------
# Step 1 - use beautiful soup to add/edit comments, head, and body tags
# ---------------------------------
...
# ---------------------------------
# Step 2- Add target_blank to all links
# ---------------------------------

...
with open(r'L:\SHARE\Rewolinski\Automating release files\Scripts\Begin_with_this_file\script2\initial_license_agreement.html', encoding="utf8") as f:
...
new_p.string = '''This is a copy of the License Agreement for Use of the UMLS®
		Metathesaurus® for the 2023AB Release from 11/06/2023. To view the
...
#load the local html file modify the input location path as needed
with open(r'L:\SHARE\Rewolinski\Automating release files\Scripts\Begin_with_this_file\script2\license_agreement_appendix.html', encoding="utf8") as f2:
...
#load the local html file modify the input location path as needed
with open(r'L:\SHARE\Rewolinski\Automating release files\Scripts\Begin_with_this_file\script2\license_agreement_snomed.html', encoding="utf8") as f3:
...
with open('L:\SHARE\Rewolinski\Automating release files\Scripts\Begin_with_this_file\script3\LicenseAgreement.html', 'w') as f4:
